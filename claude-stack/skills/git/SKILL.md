...
4. **Use the GraphQL API to get sub-issues.** Do NOT parse the issue body to find sub-issues — the body text may be stale or formatted inconsistently. Always use the API:
